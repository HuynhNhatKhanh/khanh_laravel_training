            ...
            <form method="POST" action="" enctype="multipart/form-data" id="addProductForm">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group row">
                                <label for="addProductName" class="col-sm-3 col-form-label required">Tên</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                <label for="addProductPrice" class="col-sm-3 col-form-label required">Giá bán</label>
                                <div class="col-sm-9">
                        ...
                        <div class="col-6">
                            <div class="form-group row">
                                <label for="product_image_detail" class="col-sm-3 col-form-label required">Hình ảnh</label>
                            </div>
                            <div class="form-group row">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group row">
                                <label for="addProductStatus" class="col-sm-3 col-form-label required">Trạng thái</label>
                                <div class="col-sm-9">
