                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="addProductName" id="addProductName" required placeholder="Nhập tên sản phẩm">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="addProductPrice" id="addProductPrice" required placeholder="Nhập giá bán">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select type="number" class="form-control" name="addProductStatus" id="addProductStatus">
