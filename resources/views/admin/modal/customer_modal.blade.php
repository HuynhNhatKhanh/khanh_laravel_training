                     ...
                     <form id="addCustomerForm" method="POST" class="form-horizontal">
                        ...
                        <input type="hidden" name="customer-id" id="customer-id">
                         ...
                         <div class="form-group row">
                             <label for="addCustomerName" class="col-sm-3 control-label required">Tên</label>
                         ...
                         <div class="form-group row">
                             <label for="addCustomerEmail" class="col-sm-3 control-label required">Email</label>
                             <div style="width: 75%;" class="col-sm-9">
                         ...
                         <div class="form-group row">
                             <label for="addCustomerTelNum" class="col-sm-3 control-label required">Điện thoại</label>
                             <div style="width: 75%;" class="col-sm-9">
                         ...
                         <div class="form-group row">
                             <label for="addCustomerAddress" class="col-sm-3 control-label required">Địa chỉ</label>
                             <div style="width: 75%;" class="col-sm-9">
                         ...
                         <div class="form-group row">
                             <label for="addCustomerStatus" class="col-sm-3 control-label required">Trạng thái</label>
                             <div style="width: 75%;" class="col-sm-9">
