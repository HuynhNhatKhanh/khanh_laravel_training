...
<div class="modal fade" id="FormProductModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="http://laravel.xyz/">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group row">
                                <label for="product_name_detail" class="col-sm-4 col-form-label" >Tên sản phẩm</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="product_price_detail" class="col-sm-4 col-form-label">Giá bán</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="product_description_detail" class="col-sm-4 col-form-label">Mô tả</label>
                                <div class="col-sm-8">
                                    <textarea class="form-control" id="product_description_detail" rows="8" name="product_description_detail"
                        ...
                        <div class="col-6">
                            <div class="form-group row">
                                <label for="product_image_detail" class="col-sm-4 col-form-label">Hình ảnh</label>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group row">
                                <label for="product_status_detail" class="col-sm-4 col-form-label">Trạng thái</label>
                                <div class="col-sm-8">
